...
app.get('/movies', function(req, res){
  ...
  db.getTable("moviereview").then(movies => res.json(movies));  
})
...
app.get('/reviewers', function(req, res){
  ...
  db.getTable("reviewer").then(authors => res.json(authors));
...
app.get('/publications', function(req, res){
  ...
  db.getTable("publication").then(authors => res.json(authors));
})
